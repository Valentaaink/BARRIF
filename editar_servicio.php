...
if (isset($_GET['id'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($_FILES['imagen']['name'] !== '') {
            ...
            $sql = "UPDATE servicios SET titulo = '$titulo', descripcion = '$descripcion', imagen = '$imagen' WHERE id = $id";
        } else {
            // No se cargó una nueva imagen, actualizar solo título y descripción
            $sql = "UPDATE servicios SET titulo = '$titulo', descripcion = '$descripcion' WHERE id = $id";
        }
    ...
    // Consulta SQL para recuperar los datos del servicio con el ID especificado
