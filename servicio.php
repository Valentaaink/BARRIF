    ...
    <div class="tarjetas">
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                  ...
                  if (!empty($row["imagen"])) {
                      if (strpos($row["imagen"], 'Imagenes/') !== false) {
                          ...
                          echo '<img src="Imagenes/' . $row["imagen"] . '" alt="' . $row["titulo"] . '">';
                      }
                  } else {
                      // Puedes mostrar una imagen de reemplazo o un mensaje indicando que no hay imagen disponible.
                      echo '<img src="Imagenes/imagen_no_disponible.png" alt="Imagen no disponible">';
                  }
                ...
                echo "No se encontraron tarjetas en la base de datos.";
            }
