...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES["imagen"]) && $_FILES["imagen"]["error"] == 0) {
        ...
        $ruta_destino = "Gallery/" . $imagen_nombre;
    ...
    $sql = "INSERT INTO galeria (imagen, titulo, descripcion) VALUES ('$ruta_destino', '$titulo', '$descripcion')";
    
    if ($conn->query($sql) === TRUE) {
        echo '<script>
            alert("La foto se agrego a la galeria correctamente.");
